...
outDir <- "/supp_data/benchmarks/10_Split_bin_Parameter/simulated/"
...
ggsave(filename = "Figures/SuppData/10_Sim_0_to_1_Skew.png", plot = combined_pplot, dpi = 600, height = 8, width = 14)
