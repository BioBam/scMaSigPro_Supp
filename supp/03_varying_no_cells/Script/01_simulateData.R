...
inPath <- "supp/03_varying_no_cells/Script/"
outPath <- "supp/03_varying_no_cells/Script/"
...
for (i in names(skew)) {
  ...
  img <- paste0(imgPath, "/skew_", i, "_mid_", zi[[i]][1], "_shape_", zi[[i]][2], ".png")
  ...
  table <- paste0(table_path, "/skew_", i, "_mid_", zi[[i]][1], "_shape_", zi[[i]][2], ".tsv")
  ...
  obj <- paste0(obj.path, "/skew_", i, "_mid_", zi[[i]][1], "_shape_", zi[[i]][2], ".RDS")
