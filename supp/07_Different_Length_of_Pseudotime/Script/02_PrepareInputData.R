...
for (i in names(fileNames)) {
    ...
    raw_counts_file_name <- paste0(outPath, "rawCounts/",str_list[[1]][1], "_", str_list[[1]][2], "_",
    ...
    # Save data
    cell_meta_file_name <- paste0(outPath, "rawMeta/",str_list[[1]][1], "_", str_list[[1]][2], "_",
    ...
    # Create Files
    gene_meta_file_name <- paste0(outPath, "rawGT/",str_list[[1]][1], "_", str_list[[1]][2], "_",
